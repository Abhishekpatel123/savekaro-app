...
import RowCategory, { CategoryModel } from "./helpers/Category";
...
const Home = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.root}>
      {/* Menu Options */}
      <Text style={styles.heading}>Find Deals</Text>
      ...
      <View style={{ margin: 15 }}>
        ...
        >
          <Text style={{ fontWeight: "700", fontSize: 23, letterSpacing: 0.1 }}>
            Advertise
          </Text>
        ...
        <ScrollView
          ...
          style={{ marginTop: 10 }}
        >
          {filterAdvert.length === 0 && <NoData />}
          {filterAdvert.map((res, index) => (
            <BestOffers
              key={index}
